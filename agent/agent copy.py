...
FIREWORK_API_KEY = os.environ.get("FIREWORK_API_KEY")
...
def run_multimodal_agent(ctx: JobContext, participant: rtc.RemoteParticipant):
    ...
    model = openai.realtime.RealtimeModel(
        ...
        base_url="wss://api.fireworks.ai/v1/realtime",
        input_audio_transcription=openai.realtime.realtime_model.InputTranscriptionOptions(model="FireLLaVA-13B")
    )
